...
public class Payment extends javax.swing.JFrame {
    ...
    public void date()
    {
        SimpleDateFormat dFormatmonth = new SimpleDateFormat("MMM");
        SimpleDateFormat dFormatyear = new SimpleDateFormat("yyyy");
        Date date = new Date();
        String month = dFormatmonth.format(date);
        String year = dFormatyear.format(date);
        mixDate = month+year;
...
//           ResultSet rs2 = st.executeQuery(" select * from payment inner join member where payment.month=' "+month+" ' and payment.id=' "+id+" ' and member.id=' "+id+" ' ");
            ResultSet rs1 = st.executeQuery("select month from payment where id= ' "+id+" '  "); 
//            while(rs1.next())
//            {
//                jButton3.setVisible(false);
//                JOptionPane.showMessageDialog(null, "Payment has been Already Done For this Month");
//            }
            String s = "select month from payment where id= ' "+id+" '  ";
            Statement st1 = con.createStatement();
            ResultSet rs2 = st.executeQuery(s);
            while (rs2.next()) 
            {
                String monthname = rs2.getString(1);
                if(monthname.equals(mixDate) ){
                    jButton3.setVisible(false);
                    JOptionPane.showMessageDialog(null, "Payment has been Already Done For this Month");
                }
            }
